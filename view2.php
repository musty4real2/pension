...
<title> Monthly Logbook Record</title>
...
$fetch="SELECT * FROM `voters` WHERE `date_of_rtd` AND `lg_to_vote`='$status'  ORDER BY `date` ASC LIMIT $start, $display ";
...
if ($current_page != 1) {
 echo '<center><a href="view2.php?s=' .
